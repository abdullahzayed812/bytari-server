    ...
    try {
      ...
      return {
        ...
        farms: farms.map((farm) => ({
          ...
          activationStartDate: farm.activationStartDate,
          activationEndDate: farm.activationEndDate,
          needsRenewal: farm.needsRenewal,
          reviewingRenewalRequest: farm.reviewingRenewalRequest,
